...
from dcase18.engine_run import train_one_epoch, evaluate
from dcase18.dataset import get_training_set, get_test_set, get_validation_set


def get_args_parser():
    parser = argparse.ArgumentParser('dcase18 classification', add_help=False)
    ...
    # Dataset parameters
    parser.add_argument('--data_path_train', default='./dcase18/data/dcase18_train_mp3.hdf', type=str,
                        help='train dataset path')
    parser.add_argument('--data_path_val', default='./dcase18/data/dcase18_validation_mp3.hdf', type=str,
                        help='validation dataset path')
    parser.add_argument('--data_path_test', default='./dcase18/data/dcase18_testing_mp3.hdf', type=str,
                        help='test dataset path')
    parser.add_argument('--norm_file', default='./dcase18/mean_std_128.npy', type=str,
                        help='norm file path')
    ...
    parser.add_argument('--output_dir', default='./dcase18/output_dir',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='../dcase18/log_dir',
