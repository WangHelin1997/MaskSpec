...
# %%
base_dir = "./scv2/data/"
mp3_path = "./scv2/data/mp3_audio/train/"
save_file = 'scv2_train'
classes_num = 35
# %%
...
# %%
base_dir = "./scv2/data/"
mp3_path = "./scv2/data/mp3_audio/testing/"
save_file = 'scv2_testing'
classes_num = 35
# %%
print("now working on ", mp3_path)
...
# %%
base_dir = "./scv2/data/"
mp3_path = "./scv2/data/mp3_audio/validation/"
save_file = 'scv2_validation'
classes_num = 35
# %%
print("now working on ", mp3_path)
