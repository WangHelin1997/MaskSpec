...
class SCV2Dataset(TorchDataset):
    def __init__(self, hdf5_file, sample_rate=32000, classes_num=35, clip_length=10, augment=False, in_mem=False, extra_augment=False):
        """
...
def get_training_set(train_hdf5, sample_rate=32000, classes_num=35, clip_length=1, augment=False, in_mem=False, extra_augment=True, roll=True, wavmix=True):
    ds = SCV2Dataset(
...
def get_test_set(eval_hdf5, sample_rate=32000, classes_num=35, clip_length=1):
    ds = SCV2Dataset(
...
def get_validation_set(validation_hdf5, sample_rate=32000, classes_num=35, clip_length=1):
    ds = SCV2Dataset(
...
if __name__ == "__main__":
    validation_hdf5 = './scv2/data/scv2_validation_mp3.hdf'
    eval_hdf5 = './scv2/data/scv2_testing_mp3.hdf'
    train_hdf5 = './scv2/data/scv2_train_mp3.hdf'
