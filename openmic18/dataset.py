...
class openmic18Dataset(TorchDataset):
    def __init__(self, hdf5_file, sample_rate=32000, classes_num=40, clip_length=10, augment=False, in_mem=False, extra_augment=False):
        """
...
def get_training_set(train_hdf5, sample_rate=32000, classes_num=40, clip_length=10, augment=False, in_mem=False, extra_augment=True, roll=True, wavmix=True):
    ds = openmic18Dataset(
...
def get_test_set(eval_hdf5, sample_rate=32000, classes_num=40, clip_length=10):
    ds = openmic18Dataset(
...
if __name__ == "__main__":
    eval_hdf5 = './openmic18/data/mp3/openmic_test.csv_mp3.hdf'
    train_hdf5 = './openmic18/data/mp3/openmic_train.csv_mp3.hdf'
