...
# %%
base_dir = "./dcase19/data/"
mp3_path = "./dcase19/data/mp3_audio_left/fold1_train/"
save_file = 'dcase19_train_left'
classes_num = 10
# %%
...
# %%
base_dir = "./dcase19/data/"
mp3_path = "./dcase19/data/mp3_audio_left/fold1_test/"
save_file = 'dcase19_test_left'
classes_num = 10
# %%
print("now working on ", mp3_path)
...
# %%
base_dir = "./dcase19/data/"
mp3_path = "./dcase19/data/mp3_audio_right/fold1_train/"
save_file = 'dcase19_train_right'
classes_num = 10
# %%
print("now working on ", mp3_path)
...
# %%
base_dir = "./dcase19/data/"
mp3_path = "./dcase19/data/mp3_audio_right/fold1_test/"
save_file = 'dcase19_test_right'
classes_num = 10
# %%
print("now working on ", mp3_path)
...
# %%
base_dir = "./dcase19/data/"
mp3_path = "./dcase19/data/mp3_audio_mid/fold1_train/"
save_file = 'dcase19_train_mid'
classes_num = 10
# %%
print("now working on ", mp3_path)
...
# %%
base_dir = "./dcase19/data/"
mp3_path = "./dcase19/data/mp3_audio_mid/fold1_test/"
save_file = 'dcase19_test_mid'
classes_num = 10
# %%
print("now working on ", mp3_path)
