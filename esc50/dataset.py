...
class ESCDataset(TorchDataset):
    def __init__(self, hdf5_file, sample_rate=32000, classes_num=50, clip_length=10, augment=False, in_mem=False, extra_augment=False):
        """
...
def get_training_set(train_hdf5_lists, sample_rate=32000, classes_num=50, clip_length=5, augment=False, in_mem=False, extra_augment=True, roll=True, wavmix=True):
    sets = []
    for i in train_hdf5_lists:
        sets.append(ESCDataset(
            hdf5_file=i, sample_rate=sample_rate, classes_num=classes_num, clip_length=clip_length, 
...
def get_test_set(eval_hdf5, sample_rate=32000, classes_num=50, clip_length=5):
    ds = ESCDataset(
...
if __name__ == "__main__":
    ...
    eval_hdf5 = './esc50/data/esc50_mp3_fold1.hdf'
    train_hdf5_lists = [
        './esc50/data/esc50_mp3_fold2.hdf',
        './esc50/data/esc50_mp3_fold3.hdf',
        './esc50/data/esc50_mp3_fold4.hdf',
        './esc50/data/esc50_mp3_fold5.hdf']

    print("get_base_test_set", len(get_test_set(eval_hdf5)))
    print("get_full_training_set", len(get_training_set(train_hdf5_lists)))
